...
const QUESTIONS = {
  ...
  science: {
    student: {
      P1: ["「動植物世界」單元的觀察活動（如 AI Garden 觀察、探究植物生長需要水和空氣）讓我對生物充滿好奇","「人的身體」單元的感官探究活動（如測試味道、探索感覺器官功能）幫助我認識自己的身體","「水和空氣」的實驗（如比較水與洗手液的特性）讓我學到科學知識","Magic Science「DIY 吉他」探究活動讓我學會用環保物料設計和製作樂器","Magic Science「家務助理機械人」活動讓我認識簡易電路和能量轉換"],
      P4: ["「認識地球」與「生物與環境」單元（如岩石探究、AI Garden 生態觀察）讓我學到地球科學和生態知識","「生命的延續」與「預防勝於治療」單元（如植物繁殖觀察、傳染病預防探究）幫助我理解生物和健康知識","「閉合電路」與「能源」單元（如搭建電路、GIGO 太陽能車實驗）讓我認識電學和能源轉換","Magic Science「文件夾面罩」設計與製作讓我了解物料特性和防護用品的科學原理","Magic Science「芭蕉扇」探究活動（結合《西遊記》跨課程閱讀）讓我學會公平測試"]
    },
