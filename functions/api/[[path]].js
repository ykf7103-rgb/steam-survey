...
const QUESTIONS = {
  student: {
    ...
    P4: ["我喜歡在騰訊 AI 平台上學習","AI 生成圖片和文字讓我覺得很有趣","AI 素養課程幫助我懂得正確使用 AI","製作太陽能動力車讓我學到科學知識","健康生活程式設計幫助我了解健康生活習慣"],
    P5: ["我喜歡用 AI 製作中華文化翻譯官","AI 素養課程讓我懂得判斷 AI 資訊是否可信","四格漫畫創作讓我更有創意","八大行星互動導覽讓我學到更多知識","STEAM DAY 活動讓我對環保有更深認識"],
    P6: ["AI 植物百科（識花君）讓我對植物更感興趣","專題研習提升了我的研究能力","一帶一路互動地圖幫助我了解中國地理","AI 素養課程幫助我懂得運用 AI 輔助學習","AI 幫助我探索未來的職業方向"]
  },
