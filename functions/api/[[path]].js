...
const QUESTIONS = {
  steam: {
    student: {
      ...
      P6: ["「識花君」AI 植物百科讓我對生物多樣性更感興趣","騰訊專題研習提升了我的研究能力","「一帶一路」互動地圖幫助我了解中國地理","第一學段的「AI基礎課程」幫助我懂得正確使用 AI","AI 幫助我探索未來的職業方向"]
    },
    teacher: ["STEAM 科課程有效提升學生的運算思維","騰訊 AI 平台適合用於課堂教學","STEAM DAY 活動有助學生理解科技與環保的關係","跨科整合能有效提升學生的學習動機","現有課程安排和資源足以支援教學需要"]
  },
  science: {
    student: {
      P1: ["科學課的觀察和探究活動（如 AI Garden 觀察動植物、探究植物生長需要水和空氣）讓我對生物充滿好奇","科學課的感官探究活動（如測試不同味道、探索感覺器官的功能）幫助我認識自己的身體","科學課的實驗活動（如比較水與洗手液的特性、探究水和空氣的性質）讓我學到科學知識","Magic Science 探究活動（如用環保物料製作「DIY 吉他」、認識聲音和振動）讓我學會動手設計和製作","Magic Science 探究活動（如製作「家務助理機械人」、學習簡易電路連接）讓我認識能量轉換"],
